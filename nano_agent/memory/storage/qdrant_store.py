...
TODO: 学习Qdrant实践, 包括collection操作, HSNW参数等
"""
...
class QdrantConnectionManager:
    ...
    def get_instance(
        ...
        collection_name: str = "nano_agent_vectors",
        vector_size: int = 384,
        distance: str = "cosine",
        timeout: int = 30,
        **kwargs
...
class QdrantVectorStore:
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            url: Qdrant云服务URL (如果为 None 则使用本地)
    ...
    def _ensure_collection(self):
        ...
        try:
            # 检查集合是否存在
            collections = self.client.get_collections().collections  # TODO: to understand
    ...
    def _ensure_payload_indexes(self):
        ...
        try:
            ...
            for field_name, schema_type in index_fields:
                try:  
                    self.client.create_payload_index(  # 核心代码
                        collection_name=self.collection_name,
    ...
    def add_vectors(
        ...
        try:
            ...
            for i, (vector, meta, point_id) in enumerate(zip(vectors, metadata, ids)):
                ...
                # 确保点ID是Qdrant接收的类型(无符号整数或UUID字符串)
                safe_id: Any
    ...
    def delete_memories(self, memory_ids: List[str]):
        ...
        TODO: 对比 delete_vectors() 和 delete_memories() 的区别和适用场景, 以及它们的实现细节
        """
        ...
        try:
            ...
            logger.error(f"❌ 按memory_id删除记忆失败: {e}")
            raise
