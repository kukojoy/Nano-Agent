...
class MemoryManager:
    ...
    def consolidate_memories(
        ...
        candidates = [
            ...
            if m.importance >= importance_threshold  # TODO: 需不需要加 and m.user_id == self.user_id
        ]
    ...
    def get_memory_stats(self) -> Dict[str, Any]:
        ...
        for memory_type, memory_instance in self.memory_types.items():
            ...
            stats["total_memories"] += type_stats.get("count", 0)  # 使用count字段(活跃记忆数)，而不是total_count(包含已遗忘的) TODO: ?
