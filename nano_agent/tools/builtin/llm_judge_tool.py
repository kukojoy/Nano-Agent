...
from nano_agent.evaluation.benchmarks.data_generation.dataset import AIDataset
from nano_agent.evaluation.benchmarks.data_generation.llm_judge import LLMJudgeEvaluator
from nano_agent.core.llm import NanoAgentLLM

class LLMJudgeTool(Tool):
    """LLM Judge 评估工具"""

    def __init__(self, llm: NanoAgentLLM = None):
        """初始化 LLM Judge 评估工具
        ...
        super().__init__(
            ...
            description="使用 LLM 作为评委评估数据生成质量"
        )
        self.llm = llm
