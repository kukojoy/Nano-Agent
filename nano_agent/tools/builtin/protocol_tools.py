...
class MCPTool(Tool):
    ...
    使用示例:
        >>> from nano_agent.tools.builtin import MCPTool
        >>>
        >>> # 方式1: 使用内置演示服务器
    ...
    def _create_builtin_server(self):
        ...
        try:
            ...
            server = FastMCP("NanoAgent-BuiltinServer")
            ...
            def greet(name: str = "World") -> str:
                """友好问候"""
                return f"Hello, {name}! 欢迎使用 NanoAgent MCP 工具！"
            ...
            def get_system_info() -> dict:
                ...
                return {
                    ...
                    "server_name": "NanoAgent-BuiltinServer",
                    "tools_count": 6
                }
    ...
    def _discover_tools(self):
        """发现 MCP 服务器提供的所有工具"""
        try:
            from nano_agent.protocols.mcp.client import MCPClient
            import asyncio
