...
class AIDataset:
    ...
    def __init__(
        ...
        year: Optional[int] = None,  # 用于真题数据, 如 2024, 2025
        ...
        Args:
            ...
            year: AIME 年份 (用于 real 类型)
            cache_dir: 缓存目录
        """
        self.dataset_type = dataset_type
        self.data_path = data_path
        self.year = year
        self.cache_dir = cache_dir or os.path.expanduser("~/.cache/nano_agent/aime")
    ...
    def _load_real_data(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            use_datasets_lib = False  # 使用 snapshot_download（JSONL格式）
