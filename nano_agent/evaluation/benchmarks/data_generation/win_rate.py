...
class WinRateEvaluator:
    ...
    核心接口: evaluate_win_rate (Generated, Reference) -> Win Rate Metrics
        内部流程: compare_pair: (构建提示词 -> 调用LLM -> 解析响应) -> 统计 -> 计算胜率
    """

    def __init__(
        self,
        llm: Optional[NanoAgentLLM] = None,
        ...
        Args:
            ...
            judge_model: 评委模型名称
        """
        self.llm = llm or NanoAgentLLM(model=judge_model)
